...
@Configuration
public class HomeAutomationInstarAutoConfiguration {

  @Bean
  @ConditionalOnMissingBean
  InstarDeviceFactory instarDeviceFactory() {
    return new InstarDeviceFactory();
  }


  @Bean
  @ConditionalOnMissingBean
  InstarDeviceTypeFactory instarDeviceTypeFactory() {
    return new InstarDeviceTypeFactory();
  }
